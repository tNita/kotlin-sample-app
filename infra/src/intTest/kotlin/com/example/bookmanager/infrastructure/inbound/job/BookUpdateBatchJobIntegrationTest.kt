...
import com.example.bookmanager.application.usecase.MessageDrivenBatchJobExecutor
...
class BookUpdateBatchJobIntegrationTest : IntegrationTestSupport() {
    ...
    private fun job(taskNotifier: TaskNotifier) =
        RunBookUpdateBatchJobUseCase(
            MessageDrivenBatchJobExecutor(SqsMessagePoller(sqsClient, objectMapper), idempotencyRepository, taskNotifier),
            getBook,
            updateBook,
            storage,
        )
